...
<MyFirstModal modalTitle="Sign Up for the GiveAway" modalContent="Grab Your ninja swag for half price" theme="sale" :show-modal="toggleModal" @updateShowModal = "toggleModal = $event">
